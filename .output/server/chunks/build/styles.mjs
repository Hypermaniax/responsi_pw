...
const styles = {
  ...
  "components/HeroSection.vue": () => import('./HeroSection-styles.vzAZkOeT.mjs').then(interopDefault),
  "components/HeroSection.vue?vue&type=style&index=0&scoped=f02ae395&lang.css": () => import('./HeroSection-styles.tUZZ7g_u.mjs').then(interopDefault)
};
