...
export default {
  ...
  "components/HeroSection.vue": () => import('./_nuxt/HeroSection-styles.vzAZkOeT.mjs').then(interopDefault),
  "components/HeroSection.vue?vue&type=style&index=0&scoped=f02ae395&lang.css": () => import('./_nuxt/HeroSection-styles.tUZZ7g_u.mjs').then(interopDefault)
}